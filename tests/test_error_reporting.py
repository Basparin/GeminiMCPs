...
This module tests the error reporting functionality in codesage_mcp.error_reporting,
    ...
    def test_write_error_log_success(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.dict(os.environ, {"ERROR_LOG_FILE": log_file}):
                ...
                with patch('codesage_mcp.error_reporting.datetime') as mock_datetime:
    ...
    def test_error_reporter_cleanup(self):
        ...
        with patch.object(error_reporter, '_webhook_session') as mock_session:
            ...
            with patch('asyncio.create_task') as mock_create_task:
                ...
                from codesage_mcp.error_reporting import cleanup
                cleanup()
