...
from codesage_mcp.core.chunking import DocumentChunker, chunk_file

# Import custom exceptions
from .exceptions import IndexingError, InvalidPathError, EmbeddingError
...
class IndexingManager:
        ...
        if self.faiss_index.d != expected_dimension:
            ...
            try:
                ...
                try:
                    ...
                    raise IndexingError(
                        "Failed to create fresh FAISS index after dimension mismatch",
    ...
    def index_codebase_incremental(
        ...
        if not root_path.is_dir():
            raise InvalidPathError(f"Path is not a directory: {path}", path=path)
