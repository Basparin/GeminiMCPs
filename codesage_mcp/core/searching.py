...
from codesage_mcp.core.exceptions import IndexingError, InvalidPatternError
...
class SearchingManager:
    ...
    def search_codebase(
        ...
        try:
            ...
            raise InvalidPatternError(f"Invalid regex pattern: {pattern}. Error: {e}", pattern=pattern, original_error=str(e))
