...
class CodeNode:
    ...
    __slots__ = ('node_type', 'name', 'qualified_name', 'file_path', 'start_line',
                 'end_line', 'content', 'metadata', 'embedding', 'created_at', 'updated_at', 'id')
...
class Relationship:
    ...
    __slots__ = ('source_id', 'target_id', 'relationship_type', 'layer', 'metadata', 'weight', 'created_at')
